...
(function() {
  ...
  // Created to support specific hbase keywords
  CodeMirror.defineMIME("text/x-hbase", {
	  name: "sql",
	  keywords: set("get scan"),
	  builtin: set(""),
	  atoms: set(""),
	  operatorChars: /^[*+\-%<>!=]/,
	  dateSQL: set(""),
