...
Actions.prototype.init = function()
{
	...
	this.addAction('online', function() { ui.online(); },true);
	this.addAction('offline', function() { ui.offline(); },true);
	...
	this.put('about', new Action(mxResources.get('about') + '节点批量设置', function()
	{
	    Asiainfo.ShowDialog('www.baidu.com');
